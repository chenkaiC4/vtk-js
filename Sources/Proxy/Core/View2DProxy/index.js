...
import vtkMouseRangeManipulator
  from 'vtk.js/Sources/Interaction/Manipulators/MouseRangeManipulator';
...
function vtkView2DProxy (publicAPI, model) {
  ...
  model.rightRangeManipulator = vtkMouseRangeManipulator.newInstance ({
    button: 3,
    scrollEnabled: false,
  });

  model.interactorStyle2D.addMouseManipulator (model.rangeManipulator);
  model.interactorStyle2D.addMouseManipulator (model.rightRangeManipulator);
  ...
  publicAPI.bindRepresentationToManipulator = representation => {
    ...
    model.rightRangeManipulator.removeAllListeners ();
    ...
    if (representation) {
      ...
      if (representation.getWindowWidth) {
        ...
        model.rightRangeManipulator.setHorizontalListener (
          min,
          max,
          step,
      ...
      if (representation.getWindowLevel) {
        ...
        model.rightRangeManipulator.setVerticalListener (
          min,
          max,
          step,
